...
description: AI-generate high-quality PPT images and transition videos (Nano Banana Pro + Kling AI). Auto-extract key points from documents, plan slide content, then produce 16:9 PPT images with gradient-glass or vector-illustration style, plus AI-generated transition videos composed via FFmpeg. Triggers: AI PPT 生成, 自动 PPT, PPT 图片视频, Nano Banana, 渐变毛玻璃 PPT, generate PPT from document.
---
